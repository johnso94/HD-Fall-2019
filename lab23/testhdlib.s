...
main:
	...
	mov	r0, #73		@ call print_decT(73)
	bl	print_decT
	mov	r0, #-1		@ call print_decT(-1)
	bl	print_decT
	
	mov	r0, #73		@ call print_hexT(73)
	bl	print_hexT
	mov	r0, #-1		@ call print_hexT(-1)
	bl	print_hexT
	...
	ldr	r0, helloP	@ call get_byte(helloP, 0)
	mov	r1, #0
	bl	get_byteT

	ldr	r0, helloP	@ call get_byte(helloP, 1)
	mov	r1, #1
	bl	get_byteT

	ldr	r0, helloP	@ call get_byte(helloP, 12)
	mov	r1, #12
	bl	get_byteT

	ldr	r0, helloP	@ call get_byte(helloP, 14)
	mov	r1, #14
	bl	get_byteT
	...
	ldr	r0, quoteP	@ call put_byte(quoteP, 6, 'n')
	mov	r1, #6
	mov	r2, #'n'
	bl	put_byteT

	ldr	r0, quoteP	@ call put_byte(quoteP, 7, '\'')
	mov	r1, #7
	mov	r2, #'\''
	bl	put_byteT

	ldr	r0, quoteP	@ call put_byte(quoteP, 8, 't')
	mov	r1, #8
	mov	r2, #'t'
	bl	put_byteT

	ldr	r0, quoteP	@ call put_byte(quoteP, 9, ' ')
	mov	r1, #9
	mov	r2, #' '
	bl	put_byteT

	ldr	r0, quoteP	@ call put_byte(quoteP, 24, '!')
	mov	r1, #24
	mov	r2, #'!'
	bl	put_byteT
